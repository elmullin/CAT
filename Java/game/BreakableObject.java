...
public class BreakableObject extends Actor {
	...
	*/
	...
	public boolean display() {
		...
		parent.fill(255);
		parent.ellipse(getPosition().x, getPosition().y, radius, radius);
        parent.stroke(160);
        parent.fill(0, 0);
        parent.ellipse(getPosition().x, getPosition().y, radius * 3 / 4, radius * 3 / 4);
        parent.noStroke();
        parent.fill(100, 255);
        parent.ellipse(getPosition().x, getPosition().y, radius * 5 / 8, radius * 5 / 8);
		return deletionMark;
	}
}